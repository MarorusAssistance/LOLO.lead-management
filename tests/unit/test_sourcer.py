...
from lolo_lead_management.domain.models import SearchBudget, SearchRunSnapshot
...
def test_sourcer_returns_found_dossier() -> None:
    ...
    query, dossier = stage.execute(state)

    assert query == "site:eu-startups.com/directory/ Spain AI software"
